...
public class riskManage implements java.io.Serializable {
	...
	private String userPower;  //处理风险事件的权限
	...
	public String getRiPerson() {
		return riPerson;
	}

	public void setRiPerson(String riPerson) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof riskManage))
			return false;
		riskManage castOther = (riskManage) other;
