...
public class EmployeeDAO extends HibernateDaoSupport {
	...
	// property constants
	public static final String EMP_LEVEL = "empLevel";
	public static final String EMP_DETAIL = "empDetail";
	...
	public List findByEmpLevel(Object empLevel) {
		return findByProperty(EMP_LEVEL, empLevel);
	}

	public List findByEmpDetail(Object empDetail) {
		return findByProperty(EMP_DETAIL, empDetail);
	}
	...
	public List findAll(final int offset, final int pageSize) {
		...
		try {
			...
			ServletActionContext.getRequest().getSession().setAttribute("pagecount",getHibernateTemplate().find("from Employee").size());
			List list = getHibernateTemplate().executeFind(new HibernateCallback() {
				
				public Object doInHibernate(Session session) throws HibernateException,
						SQLException {
					// TODO Auto-generated method stub
					List result = session.createQuery("from Employee")
