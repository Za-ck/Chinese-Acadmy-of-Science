...
public class AllAnalysisViewNewDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(AllAnalysisViewNewDAO.class);
	...
	public List findFile(String condition) {
		...
		log.debug("finding all AllAnalysisViewNew instances");
		try {
			 String queryString = "select fileName,count(*) from AllAnalysisViewNew as model " +
	...
	public List<RuleFile> findRuleFileList(String condition) {
		// TODO Auto-generated method stub
		log.debug("finding all AllAnalysisViewNew instances");
		try {
			 String queryString = "select fileName,count(*) from AllAnalysisViewNew as model " +
