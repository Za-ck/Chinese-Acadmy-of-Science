...
public class UsersDAO extends HibernateDaoSupport {
	...
	public static final String USER_DEP = "userDep";
	...
	public List findByUserDep(Object userDep) {
		return findByProperty(USER_DEP, userDep);
	}
	...
	public List findAll() {
		...
		try {
			String queryString = "from Users where userRname='"+1+"'";
