...
public class KeyAnalysisView implements java.io.Serializable {
	...
	/** default constructor */
	public KeyAnalysisView() {
	}

	/** minimal constructor */
	public KeyAnalysisView(String reId, String reIndep, String reRiskId,
	...
	/** full constructor */
	public KeyAnalysisView(String reId, String year, String reIndep,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KeyAnalysisView))
			return false;
		KeyAnalysisView castOther = (KeyAnalysisView) other;
