...
public class KeyAnalysisViewSta implements java.io.Serializable {
	...
	/** default constructor */
	public KeyAnalysisViewSta() {
	}

	/** minimal constructor */
	public KeyAnalysisViewSta(String reId, String reIndep, String reRiskId,
	...
	/** full constructor */
	public KeyAnalysisViewSta(String reId, String year, String reIndep,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof KeyAnalysisViewSta))
			return false;
		KeyAnalysisViewSta castOther = (KeyAnalysisViewSta) other;
