...
public class AllStaView1 implements java.io.Serializable {

	// Fields

	private AllStaViewId id;
	...
	public String getReLastdate() {
		return reLastdate;
	}

	public void setReLastdate(String reLastdate) {
		this.reLastdate = reLastdate;
	}
	...
	/** full constructor */
	public AllStaView1(AllStaViewId id) {
		this.id = id;
	}

	// Property accessors

	public AllStaViewId getId() {
		return this.id;
	}

	public void setId(AllStaViewId id) {
		this.id = id;
	}
