...
<body>
<form id="allStaQuery" name="allStaQuery" action="riskStatistic/allQuery_PartAction" method="post">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>汇总统计_本部门</span></div></div>
     				...
     				<td align="right" width="150px" height="32px">录入年份：</td>
     					...
     					<td align="right" width="60">季度：</td>
                             ...
                             <!--<a href="riskStatistic/depQueryAction"><input type="submit" value="" style="width:32px;height:32px;border:0px;background-image:url(images/mag.png)"/><span>查找</span></a> --> 
     					     ...
     					     <td><a class="linkstyle" href="riskStatistic/allExcelAction"  ><img src="images/Excel.png"/><span>导出excel</span></a>
...
function allQuery(){
 openBox('统计提示',350,150,0,'正在统计中，请等待....',''); 
	allStaQuery.action="riskStatistic/allQuery_PartAction";
	allStaQuery.submit();
}
function allDetail(){
allStaQuery.action="riskStatistic/allDetail_PartAction";
	allStaQuery.submit();
}
    </script>
