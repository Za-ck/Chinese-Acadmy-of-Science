...
<body>
<form id="StaQuery" name="StaQuery" action="riskStatistic/linkQuery_PartAction" method="post">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>环节统计_本部门</span></div></div>
	...
	<table id="linkTab" width="100%" class="tablestyle">
		<thead>
			<tr style="color:#818181;">
			  <th width="150" height="50">管理规定编码</th>
			  <th width="300">管理规定名称</th>
			  <th width="100">涉及风险编号</th>
			  <th width="100">涉及风险名称</th>
			  <th width="60">涉及部门</th>			   
...
function linkQuery(){
 openBox('统计提示',350,150,0,'正在统计中，请等待....',''); 
	StaQuery.action="riskStatistic/linkQuery_PartAction";
	StaQuery.submit();
}
    </script>
