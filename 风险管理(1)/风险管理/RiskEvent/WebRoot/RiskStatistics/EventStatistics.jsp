...
<body>
<form id="StaQuery" name="StaQuery" action="riskStatistic/eventQueryAction" method="post" onSubmit="checkinfo();">
  <div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>事件编号统计</span></div></div>
     			...
     			<tr> 
     				...
     				<td>     </td>
     					...
     					<td align="right" width="60">季度：</td>
                             ...
                             <!-- riskStatistic/eventQueryAction -->
                             <!--<a href="riskStatistic/eventQueryAction" ><input type="submit" value="" style="width:32px;height:32px;border:0px;background-image:url(images/mag.png)"><span>查找</span></a>-->  
     					     <a onClick="eventQuery()"><img src="images/mag.png"/><span>统计查询</span></a>
     					     </td>
     					     <td><a  href="riskStatistic/eventExcelAction"  ><img src="images/Excel.png"/><span>导出excel</span></a>
     				</td>
     			</tr>
     		</table>
		...
		<thead>
			<tr style="color:#818181;">
			  <th width="150" height="50">风险分类</th>
			  <th width="150">风险编号</th>
			  <th width="150">风险名称</th>
			  <th width="100">录入部门(个)</th>		
			  <th width="150">时间跨度选择</th>	 
			  <th width="100">事件个数</th>
			  <th width="100">事件个数占比</th>
		...
		<s:iterator value="esList2">
			...
			<tr>
			  ...
			  <td><a class="linkstyle" style="cursor:pointer" onClick="openBox('录入部门如下',400,150,1,'','riskStatistic/depnumSQAction?rid=<s:property value="riskId"/>&year=<s:property value="year"/>&quarter=<s:property value="quarter"/>');"><s:property value="indepnum"/></a></td>			  
...
function eventQuery(){
openBox('统计提示',350,150,0,'正在统计中，请等待....','');
	StaQuery.action="riskStatistic/eventQueryAction";
	StaQuery.submit();
}
