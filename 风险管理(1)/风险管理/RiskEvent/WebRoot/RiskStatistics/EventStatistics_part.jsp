...
<body>
<form id="StaQuery" name="StaQuery" action="riskStatistic/eventQuery_PartAction" method="post">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>事件编号统计_本部门</span></div></div>
     			...
     			<tr> 
     				<td align="right" width="150px" height="32px">录入年份：</td>
     					...
     					<td align="right" width="60">季度：</td>
                             ...
                             <!-- riskStatistic/eventQuery_PartAction -->
                             <!--<a href="riskStatistic/eventQuery_PartAction" ><input type="submit" value="" style="width:32px;height:32px;border:0px;background-image:url(images/mag.png)"><span>查找</span></a>-->  
...
function eventQuery(){
 openBox('统计提示',350,150,0,'正在统计中，请等待....','');  
	StaQuery.action="riskStatistic/eventQuery_PartAction";
	StaQuery.submit();
}
