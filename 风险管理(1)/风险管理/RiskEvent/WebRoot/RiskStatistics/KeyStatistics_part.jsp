...
<body>
<form id="keyStaQuery" name="keyStaQuery" action="riskStatistic/keyQuery_PartAction" method="post">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>关键风险统计_本部门</span></div></div>
...
function keyQuery(){
 openBox('统计提示',350,150,0,'正在统计中，请等待....',''); 
	keyStaQuery.action="riskStatistic/keyQuery_PartAction";
	keyStaQuery.submit();
}
    </script>
