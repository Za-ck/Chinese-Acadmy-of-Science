...
<form id="KeyAnalysisAllRisk" name="KeyAnalysisAllRisk" action="riskAnalysis/KeyAnaAllRiskAction" method="post">
  <div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>按风险类型分析(关键)-详细列表</span></div></div>
...
<table class="tablesquery"  width="100%" cellpadding="0"; cellspacing="0";>
  <tr> 
       ...
       <input name="riDegreeTo" id="riDegreeTo" style="width:40" value="<s:property value="riDegreeTo"/>" onKeyPress="EnterPress(event)" onKeyDown="EnterPress()" />
        ...
        <td width="60">
        <a href="riskAnalysis/KeyAnaAllRiskExcelAction" ><img src="images/Excel.png"/><span>导出Excel</span></a>	
       </td>  	
	</tr>
     </table>
...
function queryByValue(){
    openBox('统计提示',350,150,0,'正在统计中，请等待....','');
	KeyAnalysisAllRisk.action="riskAnalysis/KeyAnaAllRiskAction";
	KeyAnalysisAllRisk.submit();
}
    </script>
