...
$(function(){
 ...
 <form id="riskEvaluateContractResult" name="riskEvaluateContractResult" method="post" enctype="multipart/form-data">
    ...
    <tr>
    	<td width="120" align="left"> <a onClick="reportExport()" style="width:150px;" onMouseOver="this.style.cursor='hand'"><img  width="32" height="32" src="images/Word.png" onMouseOver="this.style.cursor='hand'"/><span>导出评估报告</span></a>
     	...
     	<td width="120" align="right"><a onclick="window.location.href='riskEvaluate/RiskEvaluateContractInputAction'"style="width:120px;cursor: pointer;"><img  width="32" height="32" src="images/return.png" onMouseOver="this.style.cursor='hand'"/><span>返回</span></a>
     	</td>
    </tr>
    ...
    <table id='mytable' class='tablestyle' width='100%'>
    	<tr style="position:relative;top:expression(this.offsetParent.scrollTop);padding:0px;">		
                    ...
                    <label style = "padding-left:50;"><font size = "3px" >表1 项目评估结果</font></label> <br/>  
                		...
                		<td width="10%" align="center" style="color:#818181;height:30px;font-size:15px;font-weight:lighter;text-align:center;border:1px solid #dadbdb;">录入时间</td>
    ...
    <s:iterator value="#contract.value">
    	<tr>
            <td align="center"><s:property value="peCategoryname"/></td>         			
    ...
    <div align = "left"  id = "adviseMC">
   	...
   	<!--    评估说明-->
   	<div align = "left"  id = "remarkMC" onClick="showdiv('monteCarloCImg')">
   	<img id="remarkImg" src="images/remarkMC.png" border="0" style="vertical-align:left;" onMouseOver="this.style.cursor='hand'"/><br/>
   	</div>
    <div align = "center" id ="monteCarloCImg" style = "display:none;">
    <img id="monteCarloImg" src="images/monteCarloC.png" border="0" style="vertical-align:middle;"/><br/>   
...
function reportExport(){
	riskEvaluateContractResult.action="riskEvaluate/evaluateReportAction";
	riskEvaluateContractResult.submit();
} 
