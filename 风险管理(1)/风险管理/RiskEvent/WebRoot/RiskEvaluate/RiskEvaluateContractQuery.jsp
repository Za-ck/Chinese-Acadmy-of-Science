...
<form id="RiskEvaluateGJQuery" name="RiskEvaluateGJQuery" action="riskEvaluate/RiskEvaluateGJQueryByConditonAction" method="post">
  <div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>工程总包项目列表</span></div></div>
...
function queryByValue(){
    openBox('统计提示',350,150,0,'正在统计中，请等待....','');
	RiskEvaluateGJQuery.action="riskEvaluate/RiskEvaluateContractQueryByConditonAction";
