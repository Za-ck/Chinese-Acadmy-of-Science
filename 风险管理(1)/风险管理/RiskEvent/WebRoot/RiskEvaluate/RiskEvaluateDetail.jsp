...
$(function(){
 ...
 <%
    ...
    request.getSession().setAttribute(ipResult.getIpId()+"investmentProject",ipResult);
    request.getSession().setAttribute(ipResult.getIpId()+"resultMap",resultMap);
...
function reportExport(){
	riskEvaluateResult.action="riskEvaluate/evaluateReportAction";
