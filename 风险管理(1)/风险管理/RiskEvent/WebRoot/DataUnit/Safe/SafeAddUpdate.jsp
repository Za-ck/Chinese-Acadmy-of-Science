...
<script language="javascript" src="/RiskEvent/js/validation-framework.js"></script>
 ...
 <body>
<form action="dataUnit/SafAddUpdateAction" method="post" enctype="multipart/form-data" name="safAddUpdateForm" id="safAddUpdateForm" onSubmit="return doValidate('safAddUpdateForm')">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle" align="center"><span>针对安全健康环境的影响评定等级新增修改</span></div></div>
<div class="MainDiv">
				 ...
				 <div id="errorDiv" style="color:red;font-weight:bold;font-size:12px"></div>
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="safIdString" type="text" class="text" style="width:154px" value="<s:property value='safId'/>"/>*</span>
						</td>
					  </tr>	
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="safLevel" type="text" class="text" style="width:154px" value="<s:property value='safLevel'/>"/>*</span>
						</td>
					  </tr>
					  <tr><td height="10"></td></tr>
					  <tr>
					    ...
					    <td>
							<textarea name="safSafety" cols="70" rows="8"><s:property value='safSafety'/></textarea>
						</td>
					  </tr>
					  <tr><td height="10"></td></tr>
					  <tr>
					    ...
					    <td>
							<textarea name="safEnvironment" cols="70" rows="8"><s:property value='safEnvironment'/></textarea>
						</td>
					  </tr>
					  </table>
				</fieldset>	
