...
<form name="employee" id="employee" method="post" action="dataUnit/EmployeeAction">
            <div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>风险事件对员工满意度的影响评定等级</span></div></div>
 <p:page pageTitle="等级编号;影响程度;影响描述"  pageVaule="empId;empLevel;empDetail" id="mytable" dataProvider="empList"
             actionUrl="dataUnit/ClientAction"
             pageNum="10"
             menu="true" 
             menuAlign="left"
             dcLineUsed="true"
             dcLink="dataUnit/EmpReadAction"
             addUsed="true" addLink="/RiskEvent/DataUnit/Employee/EmployeeAddUpdate.jsp"
             deleteUsed="true" deleteLink="dataUnit/EmpMultiDelAction"
             checkUsed="true" checkValue="empId"
             updateUsed="true" updateLink="dataUnit/EmpUpdatePreAction"
             ></p:page>
