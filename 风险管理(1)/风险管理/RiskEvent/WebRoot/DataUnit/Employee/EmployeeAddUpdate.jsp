...
<script language="javascript" src="/RiskEvent/js/validation-framework.js"></script>
 ...
 <body>
<form action="dataUnit/EmpAddUpdateAction" method="post" enctype="multipart/form-data" name="empAddUpdateForm" id="empAddUpdateForm" onSubmit="return doValidate('empAddUpdateForm')">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle" align="center"><span>针对员工满意度的影响评定等级新增修改</span></div></div>
<div class="MainDiv">
    ...
    <td class="CPanel">	
				 ...
				 <div id="errorDiv" style="color:red;font-weight:bold;font-size:12px"></div>
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="empIdString" type="text" class="text" style="width:154px" value="<s:property value='empId'/>"/>*</span>
						</td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="empLevel" type="text" class="text" style="width:154px" value="<s:property value='empLevel'/>"/>*</span>
						</td>
					  </tr>
					  <tr><td height="10"></td></tr>
					  <tr>
					    ...
					    <td><span class="red">
							<textarea name="empDetail" cols="70" rows="12"><s:property value='empDetail'/></textarea>*</span>
						</td>
					  </tr>
					  </table>
				</fieldset>	
		...
		<tr  >
			<td colspan="2" align="center" height="50px">
				...
				<input type="button" name="Submit2" value="" class="back" onClick="window.location.href='/RiskEvent/DataUnit/Employee/Employee.jsp/dataUnit/EmployeeAction'">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
