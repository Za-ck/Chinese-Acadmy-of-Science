...
<script language="javascript" src="/RiskEvent/js/validation-framework.js"></script>
 ...
 <body >
<form action="dataUnit/OpeAddUpdateAction" method="post" enctype="multipart/form-data" name="opeAddUpdateForm" id="opeAddUpdateForm" onSubmit="return doValidate('opeAddUpdateForm')">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle" align="center"><span>针对运营的影响评定等级新增修改</span></div></div>
<div class="MainDiv">
				 ...
				 <div id="errorDiv" style="color:red;font-weight:bold;font-size:12px"></div>
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="opeIdString" type="text" class="text" style="width:154px" value="<s:property value='opeId'/>"/>*</span>
						</td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td width="65%"><span class="red">
					       <input name="opeLevel" type="text" class="text" style="width:154px" value="<s:property value='opeLevel'/>"/>*</span>
						</td>
					  </tr>
					  <tr><td height="10"></td></tr>
					  <tr>
					    ...
					    <td><span class="red">
							<textarea name="opeDetail" cols="70" rows="6"><s:property value='opeDetail'/></textarea>*</span>
						</td>
					  </tr>
					  </table>
				</fieldset>	
