...
<html>
  <head>  
	...
	<script src="/RiskEvent/js/DatePicker/WdatePicker.js" type="text/javascript" defer></script> 
	<script language=javascript src="/RiskEvent/js/windows.js"></script>
</head>

<body style="font-size:12px; margin-top:5px;" onload="init();">

<form id="riskAssessManage" name="riskAssessManage" method="post" action="riskAssessBySynthesizeAction">
<div class="toptitle"><div class="toptitleleft"></div><div class="topttileright"></div><div class="toptitlemiddle"><span>考核成绩查询--综合考核</span></div></div>
...
<div class="queryDiv">
      ...
      <li style="float: left; margin-left: 10px; font-size: 14px;">
							查询时间：
							<s:select name="choosedId2" theme="simple" list="#{'0':'--请选择--','1':'录入时间','2':'发布时间','3':'应对时间'}"  style="width:154px;" onKeyPress="EnterPress(event)" onKeyDown="EnterPress()"></s:select>
...
<div id='pagetable'> 
    <table id='mytable' class='tablestyle' width='100%' height='100%' style="font-size: 14px">
    	<tr style="background-image:url(/RiskEvent/IconPage/images/thbg.png)">				
						<td rowspan="2" width="5%" align="center" height="30">序号</td>
						<td rowspan="2" width="20%" align="center">时间区间</td>
                  
                		<td rowspan="2" width="9%" align="center">部门属性</td>        
                		<td rowspan="2" width="29%" align="center">部门名称</td>
                		<td colspan="3" width="44%" align="center">考核分数</td>
                	</tr>
                	<tr style="background-image:url(/RiskEvent/IconPage/images/thbg.png)">
                		<td width="14%" align="center">风险填报考核分数</td>
                		<td width="14%" align="center">应对情况考核分数</td>
                		<td width="16%" align="center">综合考核分数<img src='/RiskEvent/IconPage/images/up.png' style='cursor:pointer;' id="score" onClick="changeUpDown()" /></td>
            		</tr>
            		...
            		%>
            		<s:iterator value='rSumList'>
            		<tr>
						<td height='25' align='center'><%=++num%></td>
            			<td align='center'><s:property value='TimeFrom'/></td>
            			<td align='center'><s:property value='depProperty'/></td>
            			<td align='center'><s:property value='depName'/></td>
            			<td align='center'><s:property value='assessResultQuarterByNum'/></td>
            			<td align='center'><s:property value='assessResultQuarterBySituation'/></td>
...
function query()
{
	document.forms[0].action="riskAssess/riskAssessQueryAction3"; 
...
function reSetmess()
{
	...
	//document.getElementById('choosedIdm').value="0";
