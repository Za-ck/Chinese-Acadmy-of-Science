...
<%--    alert(yearList);--%>
	...
	document.getElementById("reIds").value = reIdList;
   	...
   	if(confirm("确定考核?")){
   		var path="riskAssess/riskAssessAssessedAction?depId=" + depId+"&reIds="+reIds+"&years="+yearList+"&quarters="+quarterList+"&assessStatuss="+assessStatusList+"&tmpnum="+ Math.random().toString();
   	}
    $.ajax({
       url: path,
       type: 'post',
