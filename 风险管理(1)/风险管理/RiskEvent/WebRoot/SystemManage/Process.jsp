...
<div class="depDesp"><span class="textshow" style="color:#818181">审核之后自动发布</span></div>
  ...
  <input type="button" name="submitbt" value="" class="save" onClick="submitStrategyifno()" />　
				<input type="button" name="Submit2" value="" class="back" onClick="window.location.href='/RiskEvent/SystemManage/FlowsInfo.jsp/riskFlow/getRiskFlows'">
			</div>
 </form>
 <script>
      var num=100;
  ...
  function deleteStrategy(){
   ...
   function submitStrategyifno(){
	 ...
	 //var i="${ids}";
	//String i=ServletActionContext.getRequest().getSession().getAttribute("ids");
	// alert(i);
	 processadd.action="riskFlow/updateOrAddRisk?listinfo="+listinfo;
	 processadd.submit();
    }
 </script>
  </body>
