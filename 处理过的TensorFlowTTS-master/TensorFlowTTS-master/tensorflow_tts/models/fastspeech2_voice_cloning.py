...
from tensorflow_tts.models.fastspeech_voice_cloning import TFFastSpeech, get_initializer
...
class TFFastSpeechVariantPredictor(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=False):
        ...
        speaker_embeddings = speaker_ids
...
class TFFastSpeech2(TFFastSpeech):
    ...
    def _build(self):
        ...
        speaker_ids = tf.random.uniform([1, 256],maxval=30, dtype=tf.int32)
